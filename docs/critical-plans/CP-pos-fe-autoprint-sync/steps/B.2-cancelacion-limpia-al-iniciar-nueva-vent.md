...
- **Output:** Rutina `cleanupFiscalPrintTimeout()` invocada en `startNewSale()`, `onModalClosed()` y destrucción del componente.
...
- **Acceptance checklist:**
  - [x] Implementar función `cleanupFiscalPrintTimeout()` para despejar temporizador de 10s
