-- Local dev only, never production: fully paid yet claimable POS order for I.1 guard.
with o as (
  ...
  values (10,'QA-I1-20260923-01','processing','pos','direct_delivery',
          'QA I1 sobrepago',10000,0,10000,'COP',10000,0)
  returning id
), i as (
  ...
  select id,5,10000,'COP','succeeded',now(),'QA-I1-20260923-01' from o returning id
)
