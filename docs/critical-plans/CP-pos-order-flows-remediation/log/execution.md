...
| 2026-09-24 | fox | B.1 | Canónica 226c25ee6 verificada: spec 77/77, ERR-33 409 ambos catálogos, baseline 15; item-42 [-] Descartado por boss; DB-19 [x] en vivo. Paso cerrado. | evidence/B.1-spec.txt, B.1-baseline.txt, B.1-db19.txt, B1-cero-llamadores-descartado.md |
...
| 2026-09-24 | mosk | A.1 | Guard adoptado cerrado: DB-02/DB-14 por corte I.1 (10 históricas, 0 post-corte be9015d3d); backend por lectura (jest OOM infra) + frontend 44/44 Karma. Sin código, solo evidencia/registry/log. | evidence/A1-db02-db14-closure-20260924.md+.sql; A1-backend-regression-20260924.md; A1-frontend-regression-20260924.md |
