...
| 2026-09-23 | E4/Fabio | E.4 | Se corrigió rollback de claim de pago previo a persistencia y toast de platos frescos; UI canceló borrador, API pasó matriz happy/sad/brute y se corrigió GET ajeno HTTP200/cuerpo404 a HTTP404 real. Pendientes recorrido fresco mesa→detalle→cobro y cancelación `refunded`. | 93cb5da23; 19848ae4d; df42c55e2; 7687a6a5d; evidence/E4-closeout-20260923.md |
