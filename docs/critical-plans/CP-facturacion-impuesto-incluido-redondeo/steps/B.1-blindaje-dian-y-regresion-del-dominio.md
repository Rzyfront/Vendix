...
- **Acceptance checklist:**
  ...
  - [ ] F-068 — Parcial inventa cuota en linea exenta (major)
  - [ ] F-069 — Parcial en factura sin impuestos siempre 422 (major)
  - [ ] F-070 — Divisor pack en 1 en carril de notas (minor)
  - [ ] F-071 — Desempate del scaler no determinista (note)
  - [ ] F-072 — Parcial sobre aceptada pre-fix deriva 1c (note)
  - [ ] F-073 — Frontend parcial evade kernel y escala mal (major)
  - [ ] F-074 — Alias POS por item con claves irreales (major)
  - [ ] F-076 — Gate juzga carve-outs que el motor exime (major)
