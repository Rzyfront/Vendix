...
- **Acceptance checklist:**
  - [x] 'café chocolate' halla 'café negro granizado con hielo y chocolate'
  - [x] barcode sigue anulando search (FB-02 regresión verde)
  - [x] Sin search: where y orden idénticos a legacy (FB-08/FB-09)
  - [x] Query 'de la' usa fallback frase legacy sin error
  - [x] DTO: search 201chars→400, page=0→400, pos_optimized=false intacto, category_id= vacío
  - [x] Throw tokenizer simulado → HTTP real con código (no 200+success:false)
  - [x] F-003 — Try/catch findAll traga throws a 200+success:false (blocker)
  - [x] F-016 — B.1 no nombra helper/stopwords; 5 variantes (major)
  - [x] F-020 — Hermanos no usan buildProductWhere; blast falso (major)
  - [x] F-033 — search sin cota: query larga = fallo sin código (major)
  - [x] F-039 — page/limit sin @Min/@Max (major)
  - [x] F-040 — pos_optimized=false coerciona a true (major)
  - [x] F-041 — MaxLength+trim search sin dueño (major)
  - [x] F-043 — Numéricos vacíos coercionan a 0 (major)
  - [x] F-052 — Suite roja entre B.1 y B.3 sin gate por paso (major)
  - [x] F-074 — Trampas dead-code en el path de implementación (minor)
  - [x] F-075 — "Reemplazada" engaña: legacy debe sobrevivir (minor)
  - [x] F-084 — Fallback stopwords es switch semántico silencioso (minor)
  - [x] F-086 — ?ids= → [] con semántica sin pinar (minor)
  - [x] F-091 — Rollback claims overprometen ("si no", in-flight) (minor)
- **Status:** done
