// Espejo de apps/frontend/src/app/shared/constants/document-types.ts
// Catálogo de tipos de documento de identificación (Colombia).
// Cada tipo define placeholder + maxLength + regex para validación
// dinámica del campo document_number en formularios de cliente.
