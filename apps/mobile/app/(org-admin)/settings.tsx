 ...
 * Implementa 2 sub-módulos operativos (General, Modo Operativo).
 * El módulo fiscal (modo fiscal, datos fiscales, wizard DIAN) y los métodos
 * de pago (no disponibles en web aún) se reservan para iteraciones futuras.
 */
