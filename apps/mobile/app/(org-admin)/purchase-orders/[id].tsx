...
export default function PurchaseOrderDetail() {
  ...
  const receiveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      // H3: invalidar también la lista para que al volver el estado de
      // APPROVED/IN_TRANSIT → RECEIVED se vea reflejado sin pull-to-refresh.
      qc.invalidateQueries({ queryKey: ['org-purchase-orders-list'] });
