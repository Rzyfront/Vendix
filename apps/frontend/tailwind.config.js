    ...
    extend: {
      ...
      colors: {
        primary: {
          ...
          600: "#2F6F4E",
          700: "#2F6F4E",
          DEFAULT: "var(--color-primary, #2F6F4E)",
        },
        muted: "#94A3B8",
        surface: "#ffffff",
        bg: "#f8fafc",
        ...
        foreground: "var(--color-foreground, var(--color-text-primary))",
        secondary: "var(--color-secondary)",
        "muted-foreground": "var(--color-muted-foreground, #94A3B8)",
        accent: "var(--color-accent)",
        "accent-foreground": "var(--color-accent-foreground, #ffffff)",
        ring: "var(--color-ring)",
        border: "var(--color-border)",
        input: "var(--color-input, var(--color-border))",
