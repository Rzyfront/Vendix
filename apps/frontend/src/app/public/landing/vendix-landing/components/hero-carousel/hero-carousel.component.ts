  ...
  slides = [
    {
      ...
      subtitle:
        'Con Vendix, tienes el poder de unificar tu inventario, ventas y clientes en una sola plataforma impulsada por IA.',
    ...
    },
    {
      ...
      subtitle:
        'Ofrece a tus clientes una experiencia de compra fluida y consistente en todos tus canales de venta.',
    ...
    },
    {
      ...
      subtitle:
        'Personaliza cada aspecto de tu tienda online y crea una marca que tus clientes amarán con IA personalizada.',
      buttonText: 'Crea tu Tienda',
      buttonLink: '/auth/register',
      secondaryButtonText: 'Habla con un Experto',
      secondaryButtonLink:
        'mailto:quicks.dev@gmail.com?subject=Quiero%20hablar%20con%20un%20experto%20de%20Vendix',
    },
    {
      image: 'assets/images/carrusel/4.webp',
      message: 'Escala Sin Límites',
      subtitle:
        'Nuestra arquitectura robusta está diseñada para crecer contigo, desde tu primera venta hasta millones.',
    ...
    },
    {
      ...
      subtitle:
        'Toma decisiones basadas en datos con nuestros reportes y análisis avanzados en tiempo real.',
    ...
    },
    {
      ...
      subtitle:
        'Miles de emprendedores ya están construyendo el futuro del comercio inteligente con Vendix. ¿Estás listo?',
    ...
    },
    {
      ...
      subtitle:
        'Nos mantenemos a la vanguardia de la tecnología para que siempre tengas las mejores herramientas IA.',
