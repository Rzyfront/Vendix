...
export class BaseEffects {
  ...
  loadData$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() =>
        ...
        of(
          BaseActions.loadDataFailure({
            error:
              'loadData$ effect must be overridden in concrete implementation',
          }),
        ),
      ),
    ),
  ...
  createData$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() =>
        of(
          BaseActions.createDataFailure({
            error:
              'createData$ effect must be overridden in concrete implementation',
          }),
        ),
      ),
    ),
  ...
  updateData$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() =>
        of(
          BaseActions.updateDataFailure({
            error:
              'updateData$ effect must be overridden in concrete implementation',
          }),
        ),
      ),
    ),
  ...
  deleteData$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() =>
        of(
          BaseActions.deleteDataFailure({
            error:
              'deleteData$ effect must be overridden in concrete implementation',
          }),
        ),
      ),
    ),
