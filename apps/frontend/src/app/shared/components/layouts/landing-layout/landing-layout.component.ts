...
@Component({
  ...
  standalone: true,
  imports: [IconComponent], // Add IconComponent to imports
  template: `
    <div
      ...
      <header
        class="fixed top-0 left-0 right-0 z-50 bg-surface/80 backdrop-blur-xl border-b border-[var(--color-border)] shadow-sm"
        >
