...
@Component({
  ...
  template: `
    <div [class]="cardClasses" [ngStyle]="cardStyles">
      ...
      <!-- Footer -->
      @if (hasFooter) {
        <div [class]="footerClasses" [class.pt-0]="!hasBody">
...
export class CardComponent {
  ...
  readonly animateOnLoad = input(false);
  /**
   ...
   */
  readonly responsivePadding = input(false);
  /**
   ...
   */
  readonly overflow = input<'hidden' | 'visible' | 'auto'>('hidden');
  /**
  ...
  get cardClasses(): string {
    ...
    const overflowClasses = responsive
    ...
    const shadowClass = responsive ? shadowResponsive[this.shadow()] : shadowNormal[this.shadow()];
