import { Component, Input, HostListener, inject, input, output } from '@angular/core';
  ...
  template: `
    @if (isOpen()) {
      <div
        ...
        @if (currentIndex !== undefined && totalImages !== undefined && totalImages > 1) {
          <div
...
export class ImageLightboxComponent {
  ...
  readonly currentImage = input<string | SafeUrl>('');
