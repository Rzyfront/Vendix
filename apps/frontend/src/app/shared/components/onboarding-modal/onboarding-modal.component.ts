  ...
  template: `
    ...
    >
      ...
      <div class="min-h-[400px]">
        <!-- Welcome Step (Business Type Selection) -->
        ...
        <!-- Store Flow -->
        <ng-container *ngIf="businessType === 'STORE' && currentStep > 1">
          <!-- Store Setup Step -->
          ...
          <!-- Auto-generated Organization Step (Hidden, shown in completion) -->
        ...
        <!-- Organization Flow -->
        <ng-container *ngIf="businessType === 'ORGANIZATION' && currentStep > 1">
...
export class OnboardingModalComponent implements OnInit, OnDestroy {
  ...
  // Store-specific steps (5 steps total)
  storeSteps: WizardStep[] = [
    {
      id: 1,
      title: '¡Bienvenido!',
      description: 'Configura tu tienda en minutos',
      icon: 'sparkles',
      canSkip: false,
    },
    {
    ...
    },
    {
      ...
      description: 'Información autogenerada de tu empresa',
      icon: 'building',
      canSkip: false,
    },
    {
