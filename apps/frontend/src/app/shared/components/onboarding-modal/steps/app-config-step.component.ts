      ...
      <div class="app-config-container">
        ...
        <div class="config-form">
          ...
          <div class="form-section">
            <div class="section-header">
              <div class="section-icon">
                <app-icon name="droplet" size="20" class="section-icon-element"></app-icon>
              </div>
              ...
              <div class="color-inputs-grid">
                <div class="color-input-group">
                  <label class="color-label">
                    Color primario
                    <span class="color-preview" [style.background-color]="primaryColor"></span>
                  </label>
                ...
                <div class="color-input-group">
                  <label class="color-label">
                    Color secundario
                    <span class="color-preview" [style.background-color]="secondaryColor"></span>
                  </label>
                  <div class="color-input-wrapper">
                    <input
                      type="color"
          ...
          <div class="form-section">
            <div class="section-header">
              <div class="section-icon">
                <app-icon name="globe" size="20" class="section-icon-element"></app-icon>
              </div>
            ...
            <div class="domain-card auto-domain">
              <div class="domain-icon">
                <app-icon name="check-circle" size="24" class="domain-check-icon"></app-icon>
              </div>
              <div class="domain-content">
                ...
                <p class="domain-description">
                  Tu aplicación estará disponible inmediatamente en esta dirección
                </p>
              </div>
            </div>
              ...
              <div class="form-field">
                ...
                <div class="field-hint">
                  ...
                  <span class="hint-text">
                    Después de completar el wizard, te ayudaremos a configurar DNS y SSL
                  </span>
                </div>
              </div>
            </div>
