...
@Component({
  ...
  styles: [`
    ...
    .welcome-context {
      background: linear-gradient(135deg, rgba(126, 215, 165, 0.1) 0%, rgba(47, 111, 78, 0.05) 100%);
      ...
      <div class="welcome-container">
        ...
        <div class="welcome-header">
          ...
          <p class="welcome-subtitle">
            ...
            Te guiaremos paso a paso para que todo quede perfecto.
          </p>
        </div>
        ...
        <div class="welcome-context">
          ...
          <p class="context-text">
            Estás en el asistente de configuración inicial de Vendix.
            Aquí configuraremos tu tienda, organización y preferencias para que puedas empezar a vender hoy mismo.
          </p>
        </div>
        ...
        <div class="business-type-selector">
          ...
          >
            ...
            <p class="business-type-description">
              Perfecto si tienes un solo negocio o punto de venta. Configura todo lo necesario para empezar a vender rápidamente.
            </p>
          ...
          >
            ...
            <p class="business-type-description">
              Ideal si tienes múltiples tiendas, sucursales o planeas escalar tu negocio. Gestiona todo desde un panel central.
            </p>
...
export class WelcomeStepComponent implements OnInit {
  ...
  @Output() businessTypeSelected = new EventEmitter<{ type: 'STORE' | 'ORGANIZATION' }>();
