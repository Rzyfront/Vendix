    ...
    <div class="organization-step">
      ...
      <div class="organization-content">
        ...
        <form class="organization-form" [formGroup]="formGroup()">
          ...
          <!-- Fiscal Information Section (optional, collapsed by default).
               ORGANIZATION-exclusive: guarded so it never renders in another flow. -->
...
export class OrganizationSetupStepComponent {
  ...
  readonly isAutoGenerated = input<boolean>(false);
  readonly storeName = input<string>('');
  // Path chosen in the welcome step. This component is ORGANIZATION-exclusive,
  // but the fiscal section is conditioned on it defensively so the section can
  // never leak if the component is ever reused in another flow.
