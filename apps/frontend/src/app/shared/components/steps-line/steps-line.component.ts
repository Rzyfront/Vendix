...
export class StepsLineComponent {
  ...
  @Input() currentStep = 0;
  @Input() primaryColor = 'var(--color-primary)';
  @Input() secondaryColor = 'var(--color-secondary)';
  ...
  get circleOffset(): string {
    if (this.size === 'sm') return '0.75rem';
    if (this.size === 'lg') return '1.25rem';
    return '1rem'; // md
  }

  get circleClasses(): string {
    if (this.size === 'sm') return 'w-6 h-6 text-[0.65rem]';
    if (this.size === 'lg') return 'w-10 h-10 text-sm';
    return 'w-8 h-8 text-xs'; // md
  }

  get checkClasses(): string {
    if (this.size === 'sm') return 'w-2.5 h-2.5';
    if (this.size === 'lg') return 'w-[18px] h-[18px]';
    return 'w-3.5 h-3.5'; // md
  }

  get labelClasses(): string {
    if (this.size === 'sm') return 'text-[0.6rem]';
    if (this.size === 'lg') return 'text-sm';
    return 'text-[0.7rem]'; // md
  }

  get verticalLineClasses(): string {
    if (this.size === 'sm') return 'h-4';
    if (this.size === 'lg') return 'h-7';
    return 'h-5'; // md
  }
