    ...
    >
      @if (log(); as auditLog) {
        <div class="flex flex-col gap-6 p-1">
          <!-- Información General -->
          <app-card shadow="none" [padding]="false">
            <div slot="header" class="px-4 py-3 bg-muted/30 border-b border-border flex items-center gap-2">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1">
                  ...
                  <span class="text-sm text-text-primary">{{
                    auditLog.users
                      ? auditLog.users.first_name +
                        ' ' +
                        auditLog.users.last_name
                      : 'Sistema'
                  }}</span>
                </div>
                <div class="flex flex-col gap-1">
                  ...
                  <span
                    ...
                    [title]="auditLog.users?.email"
                    >{{ auditLog.users?.email || 'N/A' }}</span
                  >
                </div>
                <div class="flex flex-col gap-1">
                  <span class="text-xs font-medium text-text-secondary"
                  ...
                  <div>
                    <span
                      [class]="
                        ...
                        getBadgeClasses(auditLog.action)
                      "
                    >
                ...
                <div class="flex flex-col gap-1">
                  ...
                  >
                  <span class="text-sm text-text-primary">{{
                    getResourceDisplay(auditLog.resource)
                  }}</span>
                </div>
                <div class="flex flex-col gap-1">
                  <span class="text-xs font-medium text-text-secondary"
      ...
      <div
        slot="footer"
        class="flex justify-end p-4 bg-surface border-t border-border"
      >
