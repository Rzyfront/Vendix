...
export class OrganizationCardComponent {
  readonly organization = input.required<OrganizationListItem>();
  readonly cardClick = output<OrganizationListItem>();
  readonly view = output<OrganizationListItem>();
  readonly edit = output<OrganizationListItem>();
  readonly delete = output<OrganizationListItem>();
