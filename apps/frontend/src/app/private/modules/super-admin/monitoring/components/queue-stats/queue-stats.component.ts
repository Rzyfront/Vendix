  ...
  template: `
    ...
    >
      <div
        ...
        style="border-bottom: 1px solid var(--color-border); background: linear-gradient(135deg, rgba(99,102,241,0.05) 0%, transparent 100%);"
      >
        <span
          class="w-5 h-5 rounded flex items-center justify-center bg-indigo-500/10"
        >
          <svg
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
            ...
            >
              ...
              <p
                ...
                [class.text-red-500]="totalFailed > 0"
                [style.color]="
                  totalFailed === 0 ? 'var(--color-text-muted)' : ''
                "
              >
                {{ totalFailed }}
              </p>
            ...
            <div class="space-y-2">
              @for (q of queues; track trackByName($index, q)) {
                ...
                >
                  ...
                  <div
                    class="flex items-center gap-4 text-xs font-mono shrink-0"
                  >
                    ...
                    <span class="flex flex-col items-center">
                      ...
                      >
                      <span
                        [class.text-red-500]="q.failed > 0"
                        [style.color]="
                          q.failed === 0 ? 'var(--color-text-muted)' : ''
                        "
                        class="font-bold"
                        >{{ q.failed }}</span
                      >
