...
import { CatalogService, Product, Category, Brand, CatalogQuery } from '../../services/catalog.service';
...
export class CatalogComponent implements OnInit, OnDestroy {
    ...
    loadProducts(): void {
        ...
        if (this.selected_category_id) query.category_id = this.selected_category_id;
    ...
    private updateUrl(): void {
        ...
        if (this.selected_category_id) queryParams.category = this.selected_category_id;
