...
export const ANALYTICS_VIEWS: AnalyticsView[] = [
  ...
  },
  {
    ...
    detailedDescription: 'Descubre quais produtos estao gerando mais receita e qual e sua participacao nas vendas totais.',
  ...
  },
  {
    ...
    detailedDescription: 'Analiza quais metodos de pagamento seus clientes preferem usar no checkout.',
  ...
  },
  {
    ...
    detailedDescription: 'Calcula el valor de tu inventario usando diferentes metodos de valoracion contable.',
  ...
  },
  {
    ...
    detailedDescription: 'Rastrea nuevos clientes y identifica quais canais estao trazendo mais conversoes.',
