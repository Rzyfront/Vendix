      ...
      >
        @for (category of analyticsCategories; track category.id) {
          <app-card
            ...
            shadow="none"
            [padding]="false"
            customClasses="group hover:border-primary/50 hover:shadow-md transition-all duration-200 cursor-pointer"
          >
            <!-- Icon & Title -->
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: '',
          route: './inventory/movement-analysis',
        },
        {
          id: 'valuation',
          label: 'Valoración',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Top Sellers',
          description: '',
          route: './products/top-sellers',
        },
        {
          id: 'profitability',
          label: 'Rentabilidad',
          description: '',
          route: './products/profitability',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: '',
          route: './purchases/summary',
        },
        {
          id: 'by-supplier',
          label: 'Compras por Proveedor',
          description: '',
          route: './purchases/by-supplier',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Adquisición',
          description: '',
          route: './customers/acquisition',
        },
        {
          id: 'abandoned-carts',
          label: 'Carritos Abandonados',
          description: '',
          route: './customers/abandoned-carts',
        },
      ],
    },
    {
