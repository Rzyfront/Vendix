...
@Component({
  ...
  template: `
    <div class="space-y-6 w-full max-w-[1600px] mx-auto py-4">
      ...
      <h1 class="text-2xl font-bold text-text-primary">Resumen de Clientes</h1>
      <div class="bg-surface border border-border rounded-xl p-8 text-center">
        <app-icon name="users" [size]="48" class="text-text-tertiary mx-auto mb-4"></app-icon>
        <h3 class="text-lg font-semibold text-text-primary">Próximamente</h3>
        <p class="text-text-secondary mt-2">El reporte de clientes estará disponible pronto.</p>
      </div>
    </div>
  `,
})
