  ...
  template: `
    <div class="p-6">
      <div class="mb-6">
        ...
        <p class="text-gray-600">View detailed information about this order</p>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-sm border p-8">
        <div class="text-center">
          ...
          <p class="text-gray-600 max-w-md mx-auto mt-2">
            Order details view is under development. You will be able to view complete order information here.
          </p>
        </div>
      </div>
    </div>
