...
import { GymRenewMembershipModalComponent } from '../../components/renew-membership-modal/renew-membership-modal.component';
...
@Component({
  selector: 'app-gym-membership-detail-page',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    StickyHeaderComponent,
    ...
    SettingToggleComponent,
    TextareaComponent,
    GymRenewMembershipModalComponent,
  ],
  templateUrl: './membership-detail-page.component.html',
})
export class GymMembershipDetailPageComponent implements OnInit {
  ...
  goToProfile(): void {
    const m = this.membership();
    if (!m) return;
    this.router.navigate(['/admin/gym-ops/members/profile', m.customer_id]);
  }
