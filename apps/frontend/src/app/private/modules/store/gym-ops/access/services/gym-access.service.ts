...
/**
 * Store-scoped service for gym access control (Gym Suite — Ola 1).
 *
 * Mirrors `apps/backend/src/domains/store/gym-access` (`/store/gym/access`):
 * credentials CRUD, access logs listing, and the reception validate endpoint.
 */
@Injectable({ providedIn: 'root' })
export class GymAccessService {
  private readonly apiUrl = environment.apiUrl;
  private readonly basePath = '/store/gym/access';
