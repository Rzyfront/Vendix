/**
 * Gym Suite — Ola 1.
 * Frontend source of truth for the gym plans (membership tariffs) domain.
 *
 * Mirrors the Prisma model `gym_plans` and the DTO contracts exposed by
 * `apps/backend/src/domains/store/gym-plans` (create / update / query).
 */
