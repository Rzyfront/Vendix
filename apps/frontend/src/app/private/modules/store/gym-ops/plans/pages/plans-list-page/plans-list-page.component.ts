...
@Component({
  selector: 'app-gym-plans-list-page',
  standalone: true,
  imports: [
    FormsModule,
    StickyHeaderComponent,
...
export class GymPlansListPageComponent implements OnInit {
  ...
  createPlan(): void {
    this.router.navigate(['/admin/gym-ops/plans/new']);
  }

  editPlan(plan: GymPlan): void {
    this.router.navigate(['/admin/gym-ops/plans', plan.id, 'edit']);
  }
