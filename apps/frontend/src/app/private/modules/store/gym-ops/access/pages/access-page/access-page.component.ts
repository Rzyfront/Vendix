...
import { GymCredentialFormModalComponent } from '../../components/credential-form-modal/credential-form-modal.component';
...
@Component({
  ...
  imports: [
    ...
    PaginationComponent,
    EmptyStateComponent,
    GymCredentialFormModalComponent,
  ],
  templateUrl: './access-page.component.html',
})
export class GymAccessPageComponent implements OnInit {
