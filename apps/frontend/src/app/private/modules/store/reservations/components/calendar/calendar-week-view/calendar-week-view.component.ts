...
export class CalendarWeekViewComponent {
  ...
  private formatDateStr(d: Date): string {
    // Use UTC methods to match the calendar-container's formatDate
    // and the backend's UTC storage of bookings.date. See that
    // method's comment for the full timezone rationale.
