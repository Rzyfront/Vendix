  ...
  template: `
    ...
    >
      <div class="p-4" *ngIf="invoice">
        ...
        <!-- Resolution -->
        <div *ngIf="invoice.resolution" class="mb-4 text-sm p-2 bg-blue-50 rounded-lg">
        ...
        <!-- Taxes Summary -->
        <div *ngIf="invoice.taxes && invoice.taxes.length > 0" class="mb-4">
          <h4 class="text-sm font-semibold text-text-primary mb-2">Impuestos</h4>
          <div class="space-y-1">
            <div *ngFor="let tax of invoice.taxes" class="flex justify-between text-sm">
        ...
        <div class="border-t border-border pt-3 space-y-1">
          ...
          <div *ngIf="invoice.discount_amount > 0" class="flex justify-between text-sm">
          ...
          <div *ngIf="invoice.withholding_amount > 0" class="flex justify-between text-sm">
        ...
        <!-- Notes -->
        <div *ngIf="invoice.notes" class="mt-4 p-3 bg-gray-50 rounded-lg">
          <h4 class="text-sm font-semibold text-text-primary mb-1">Notas</h4>
          <p class="text-sm text-text-secondary">{{ invoice.notes }}</p>
        </div>

        <!-- DIAN Status -->
        <div *ngIf="invoice.send_status" class="mt-4 p-3 bg-gray-50 rounded-lg">
        ...
        <div *ngIf="invoice.cufe || invoice.qr_code || invoice.pdf_url" class="mt-4 p-3 bg-green-50 rounded-lg space-y-3">
          <h4 class="text-sm font-semibold text-green-800">Información DIAN</h4>
          <div *ngIf="invoice.cufe" class="flex items-center gap-2">
        ...
        <!-- Cross-module Links -->
        <div *ngIf="invoice.order_id" class="mt-4">
