...
@Component({
  selector: 'app-membership-plan-form-page',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    StickyHeaderComponent,
...
export class MembershipPlanFormPageComponent implements OnInit {
    ...
    this.plansService
      ...
      .subscribe({
        ...
        error: (err: unknown) => {
          ...
          this.isLoadingPlan.set(false);
          this.router.navigate(['/admin/memberships/plans']);
        },
      });
  }

  onHeaderAction(actionId: string): void {
    if (actionId === 'cancel') this.router.navigate(['/admin/memberships/plans']);
