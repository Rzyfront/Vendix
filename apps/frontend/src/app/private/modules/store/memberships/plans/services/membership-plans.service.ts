...
/**
 * Store-scoped service for the Membership Plans domain.
 *
 * Mirrors the backend controller for membership plans
 * (`/store/memberships/plans`). The backend
...
export class MembershipPlansService {
  ...
  private readonly basePath = '/store/memberships/plans';
