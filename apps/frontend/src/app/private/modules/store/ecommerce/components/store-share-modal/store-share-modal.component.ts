import { Component, inject, input, output, model, signal } from '@angular/core';
...
export class StoreShareModalComponent {
  ...
  readonly storeUrl = input<string | null>(null);
  readonly storeName = input('');
  readonly logoUrl = input<string | null>(null);
  readonly primaryColor = input('#3B82F6');
  readonly secondaryColor = input('#10B981');
