...
@Component({
  selector: 'app-inventory-low-stock-report',
  standalone: true,
...
export class InventoryLowStockReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'inventory-low-stock' }));
  }
