...
@Component({
  selector: 'app-sales-by-customer-report',
  standalone: true,
...
export class SalesByCustomerReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'sales-by-customer' }));
  }
