    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'sales-by-seller', loadComponent: () => import('./pages/generic-report-page/generic-report-page.component').then(c => c.GenericReportPageComponent), data: { reportId: 'sales-by-seller' } },
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'inventory-by-supplier', loadComponent: () => import('./pages/generic-report-page/generic-report-page.component').then(c => c.GenericReportPageComponent), data: { reportId: 'inventory-by-supplier' } },
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'customers-receivable', loadComponent: () => import('./pages/aging-report-page/aging-report-page.component').then(c => c.AgingReportPageComponent), data: { reportId: 'customers-receivable' } },
          { path: 'customers-aging', loadComponent: () => import('./pages/aging-report-page/aging-report-page.component').then(c => c.AgingReportPageComponent), data: { reportId: 'customers-aging' } },
        ],
      },
      {
        path: 'purchases',
        ...
        children: [
          ...
          { path: 'purchase-aging', loadComponent: () => import('./pages/aging-report-page/aging-report-page.component').then(c => c.AgingReportPageComponent), data: { reportId: 'purchase-aging' } },
        ],
      },
      {
        path: 'reviews',
