...
@Component({
  selector: 'app-inventory-stock-levels-report',
  standalone: true,
...
export class InventoryStockLevelsReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'inventory-stock-levels' }));
  }
