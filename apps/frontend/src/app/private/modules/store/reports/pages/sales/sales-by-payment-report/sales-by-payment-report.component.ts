...
@Component({
  selector: 'app-sales-by-payment-report',
  standalone: true,
...
export class SalesByPaymentReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'sales-by-payment' }));
  }
