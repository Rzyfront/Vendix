...
@Component({
  selector: 'app-accounts-payable-aging-report',
  standalone: true,
...
export class AccountsPayableAgingReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'accounts-payable-aging' }));
  }
