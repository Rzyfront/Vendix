...
@Component({
  selector: 'app-inventory-movements-report',
  standalone: true,
...
export class InventoryMovementsReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'inventory-movements' }));
  }
