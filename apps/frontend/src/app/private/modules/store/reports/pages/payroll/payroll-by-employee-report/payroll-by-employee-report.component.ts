...
@Component({
  selector: 'app-payroll-by-employee-report',
  standalone: true,
...
export class PayrollByEmployeeReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'payroll-by-employee' }));
  }
