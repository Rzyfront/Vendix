...
export const REPORT_DEFINITIONS: ReportDefinition[] = [
...

  {
    ...
    stats: [
      ...
      { key: 'total_products', label: 'Productos', type: 'number', icon: 'package' },
      { key: 'total_customers', label: 'Clientes', type: 'number', icon: 'users' },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { key: 'products_count', label: 'Productos', type: 'number', icon: 'package' },
...

  {
    ...
    stats: [
      ...
      { key: 'total_quantity', label: 'Cantidad Total', type: 'number', icon: 'layers' },
      { key: 'percentage', label: 'Participacion', type: 'percentage', icon: 'pie-chart' },
      { key: 'count', label: 'Transacciones', type: 'number', icon: 'list' },
    ],
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'new_customers', header: 'Nuevos Clientes', type: 'number', footer: 'sum' },
      { key: 'conversion_rate', header: 'Tasa Conversion', type: 'percentage' },
      { key: 'revenue', header: 'Ingreso Generado', type: 'currency', footer: 'sum' },
    ],
    exportFilename: 'adquisicion-clientes',
    stats: [
      { key: 'new_customers', label: 'Nuevos Clientes', type: 'number', icon: 'user-plus' },
      { key: 'conversion_rate', label: 'Tasa Conversion', type: 'percentage', icon: 'percent' },
      { key: 'revenue', label: 'Ingreso', type: 'currency', icon: 'dollar-sign' },
      { key: 'channels', label: 'Canales', type: 'number', icon: 'share-2' },
    ],
  ...
  },
  {
    ...
    columns: [
      { key: 'customer_name', header: 'Cliente', type: 'text' },
      { key: 'cart_total', header: 'Total Carrito', type: 'currency' },
      { key: 'items_count', header: 'Productos', type: 'number' },
      { key: 'abandoned_at', header: 'Fecha Abandono', type: 'date' },
      { key: 'recovered', header: 'Recuperado', type: 'text' },
    ],
...

  {
    ...
    stats: [
      ...
      { key: 'account_count', label: 'Total Cuentas', type: 'number', icon: 'list' },
...

  {
    ...
    stats: [
      { key: 'total_debit', label: 'Total Debitos', type: 'currency', icon: 'arrow-up' },
      { key: 'total_credit', label: 'Total Creditos', type: 'currency', icon: 'arrow-down' },
      { key: 'entry_count', label: 'Total Asientos', type: 'number', icon: 'file-text' },
      { key: 'balance', label: 'Saldo', type: 'currency', icon: 'scale' },
    ],
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'book_value', header: 'Valor en Libros', type: 'currency' },
      { key: 'useful_life', header: 'Vida Util', type: 'number' },
    ],
    ...
    stats: [
      ...
      { key: 'book_value', label: 'Valor en Libros', type: 'currency', icon: 'landmark' },
      { key: 'accumulated_depreciation', label: 'Dep. Total', type: 'currency', icon: 'trending-down' },
    ],
    dataEndpoint: 'store/accounting/fixed-assets/reports/book-values',
  },
  {
    id: 'receivables',
    category: 'accounting',
    ...
    columns: [
      { key: 'customer_name', header: 'Cliente', type: 'text' },
      { key: 'invoice_number', header: 'Factura', type: 'text' },
      { key: 'total_amount', header: 'Monto Total', type: 'currency' },
      { key: 'balance', header: 'Saldo', type: 'currency', footer: 'sum' },
    ...
    stats: [
      ...
      { key: 'total_amount', label: 'Monto Total', type: 'currency', icon: 'landmark' },
      { key: 'days_overdue', label: 'Dias Mora', type: 'number', icon: 'clock' },
    ],
  ...
  },
  {
    ...
    trackKey: 'employee_id',
    columns: [
      { key: 'full_name', header: 'Nombre', type: 'text' },
      ...
      { key: 'start_date', header: 'Fecha Ingreso', type: 'date' },
      { key: 'status', header: 'Estado', type: 'text' },
    ],
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'total_earnings', header: 'Total Devengado', type: 'currency', footer: 'sum' },
      { key: 'total_deductions', header: 'Total Deducciones', type: 'currency', footer: 'sum' },
      { key: 'net_pay', header: 'Neto Pagado', type: 'currency', footer: 'sum' },
      { key: 'employee_count', header: 'Empleados', type: 'number', footer: 'sum' },
      { key: 'status', header: 'Estado', type: 'text' },
    ],
  ...
  },
  {
    ...
    requiresFiscalPeriod: false,
    type: 'list' as ReportType,
    trackKey: 'settlement_id',
    columns: [
      { key: 'employee_name', header: 'Empleado', type: 'text' },
      { key: 'settlement_type', header: 'Tipo', type: 'text' },
      { key: 'total_amount', header: 'Monto Total', type: 'currency', footer: 'sum' },
      { key: 'deductions', header: 'Deducciones', type: 'currency', footer: 'sum' },
    ...
    stats: [
      ...
      { key: 'total_amount', label: 'Monto Total', type: 'currency', icon: 'dollar-sign' },
      { key: 'net_amount', label: 'Neto', type: 'currency', icon: 'calculator' },
      { key: 'deductions', label: 'Deducciones', type: 'currency', icon: 'trending-down' },
    ],
  ...
  },
  {
    ...
    columns: [
      { key: 'employee_name', header: 'Empleado', type: 'text' },
      { key: 'amount', header: 'Monto', type: 'currency', footer: 'sum' },
      { key: 'request_date', header: 'Fecha Solicitud', type: 'date' },
      { key: 'approval_date', header: 'Fecha Aprobacion', type: 'date' },
      { key: 'status', header: 'Estado', type: 'text' },
    ],
...

  {
    ...
    stats: [
      ...
      { key: 'refund_count', label: 'Cantidad', type: 'number', icon: 'rotate-ccw' },
      { key: 'avg_refund', label: 'Promedio', type: 'currency', icon: 'calculator' },
      { key: 'approval_rate', label: 'Tasa Aprobacion', type: 'percentage', icon: 'check-circle' },
    ],
