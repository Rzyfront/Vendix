...
export const REPORT_DEFINITIONS: ReportDefinition[] = [
...

  {
    ...
    stats: [
      { key: '_count', label: 'Total Remisiones', type: 'number', icon: 'file-text' },
...

  {
    ...
    columns: [
      ...
      { key: 'placa_vehiculo', header: 'Placa', type: 'text' },
      { key: 'paradas_total', header: 'Paradas', type: 'number', footer: 'sum' },
...

  {
    ...
    columns: [
      ...
      { key: 'rutas_total', header: 'Total Rutas', type: 'number', footer: 'sum' },
      { key: 'is_active', header: 'Activo', type: 'text' },
    ],
    exportFilename: 'vehiculos_despacho',
    stats: [
      { key: 'rutas_total', label: 'Total Rutas', type: 'number', icon: 'truck' },
