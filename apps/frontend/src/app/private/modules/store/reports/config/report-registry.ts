...
export const REPORT_DEFINITIONS: ReportDefinition[] = [
...

  {
    ...
    stats: [
      ...
      { key: 'completed_count', label: 'Recibidas', type: 'number', icon: 'check-circle' },
    ],
...

  {
    ...
    columns: [
      ...
      { key: 'days_overdue', header: 'Días Mora', type: 'number', footer: 'average' },
    ...
    stats: [
      ...
      { key: 'days_overdue', label: 'Prom. Días Mora', type: 'number', icon: 'clock-alert' },
      { key: '_count', label: '# Órdenes Pendientes', type: 'number', icon: 'file-text' },
      { key: 'tax_amount', label: 'Total Impuestos', type: 'currency', icon: 'percent' },
    ],
...

  {
    ...
    columns: [
      ...
      { key: 'ticket_promedio', header: 'Ticket Promedio', type: 'currency', footer: 'average' },
    ...
    stats: [
      ...
      { key: 'ticket_promedio', label: 'Ticket Promedio', type: 'currency', icon: 'receipt' },
      { key: '_count', label: 'Canales', type: 'number', icon: 'radio' },
    ],
...

  {
    ...
    stats: [
      ...
      { key: '_count', label: 'Productos', type: 'number', icon: 'package' },
      { key: 'reorder_point', label: 'Punto Reorden Prom.', type: 'number', icon: 'alert-triangle' },
    ],
...

  {
    ...
    stats: [
      ...
      { key: 'product_count', label: 'Productos', type: 'number', icon: 'package' },
      { key: 'preferred_count', label: 'Productos Preferidos', type: 'number', icon: 'star' },
...

  {
    ...
    columns: [
      ...
      { key: 'days_overdue', header: 'Días Mora', type: 'number', footer: 'average' },
      { key: 'aging_bucket', header: 'Antigüedad', type: 'text' },
      { key: 'original_amount', header: 'Original', type: 'currency', footer: 'sum' },
    ...
    stats: [
      ...
      { key: 'original_amount', label: 'Total Original', type: 'currency', icon: 'file-text' },
      { key: 'paid_amount', label: 'Total Pagado', type: 'currency', icon: 'check-circle' },
      { key: '_count', label: '# Documentos', type: 'number', icon: 'layers' },
    ],
...

  {
    ...
    columns: [
      ...
      { key: 'last_order_date', header: 'Última Orden', type: 'date' },
      { key: 'days_since_last_order', header: 'Días Sin Comprar', type: 'number', footer: 'average' },
      { key: 'aging_bucket', header: 'Antigüedad', type: 'text' },
      { key: 'total_orders', header: 'Órdenes', type: 'number', footer: 'sum' },
    ...
    stats: [
      ...
      { key: 'total_orders', label: 'Órdenes Totales', type: 'number', icon: 'shopping-cart' },
      { key: 'days_since_last_order', label: 'Prom. Días Sin Comprar', type: 'number', icon: 'calendar' },
      { key: '_count', label: 'Clientes', type: 'number', icon: 'users' },
    ],
...

  {
    ...
    stats: [
      ...
      { key: '_count', label: 'Sesiones', type: 'number', icon: 'calculator' },
    ],
  ...
  },
  {
    ...
    columns: [
      ...
      { key: 'total_amount', header: 'Total', type: 'currency', footer: 'sum' },
      { key: 'average_expense', header: 'Promedio', type: 'currency', footer: 'average' },
      { key: 'percentage', header: '% Participación', type: 'percentage' },
    ],
  ...
  },
  {
    ...
    columns: [
      ...
      // Columnas virtuales (no se muestran en la tabla) que alimentan
      // los stats # Reconocidos y # Pendientes via footer:count.
      { key: 'recognized_count', header: 'Reconocido (1/0)', type: 'number', footer: 'sum' },
      { key: 'pending_count', header: 'Pendiente (1/0)', type: 'number', footer: 'sum' },
