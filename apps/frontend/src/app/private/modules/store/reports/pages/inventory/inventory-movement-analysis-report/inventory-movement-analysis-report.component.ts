...
@Component({
  selector: 'app-inventory-movement-analysis-report',
  standalone: true,
...
export class InventoryMovementAnalysisReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'inventory-movement-analysis' }));
  }
