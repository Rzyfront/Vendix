...
@Component({
  selector: 'app-sales-by-channel-report',
  standalone: true,
...
export class SalesByChannelReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'sales-by-channel' }));
  }
