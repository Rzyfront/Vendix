...
@Component({
  selector: 'app-reviews-by-product-report',
  standalone: true,
...
export class ReviewsByProductReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'reviews-by-product' }));
  }
