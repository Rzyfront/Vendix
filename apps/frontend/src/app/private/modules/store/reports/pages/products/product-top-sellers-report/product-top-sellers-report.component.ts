...
@Component({
  selector: 'app-product-top-sellers-report',
  standalone: true,
...
export class ProductTopSellersReportComponent {
  ...
  constructor() {
    this.store.dispatch(ReportsActions.selectReport({ reportId: 'product-top-sellers' }));
  }
