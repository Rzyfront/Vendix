...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div
        slot="footer"
        class="flex flex-col sm:flex-row justify-end items-center gap-3 px-4 md:px-6 py-4 bg-gray-50 rounded-b-xl"
      >
        <div class="order-2 sm:order-1">
          @if (currentStep === 2) {
            <app-button
              ...
              type="button"
              (clicked)="goToStep(1)"
              customClasses="!rounded-xl w-full sm:w-auto whitespace-nowrap"
            >
        ...
        <div class="flex gap-3 order-1 sm:order-2 w-full sm:w-auto">
          <app-button
            ...
            type="button"
            (clicked)="onCancel()"
            customClasses="!rounded-xl font-bold w-full sm:w-auto whitespace-nowrap"
          >
            Cancelar
          </app-button>
          @if (currentStep === 1) {
            <app-button
              ...
              customClasses="!rounded-xl font-bold shadow-md shadow-primary-200 w-full sm:w-auto whitespace-nowrap"
            >
              Continuar
            ...
            <app-button
              ...
              customClasses="!rounded-xl font-bold shadow-md shadow-primary-200 active:scale-95 transition-all w-full sm:w-auto whitespace-nowrap"
            >
              Crear Ajuste
            </app-button>
          }
