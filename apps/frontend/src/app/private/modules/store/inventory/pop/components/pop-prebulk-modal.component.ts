        ...
        <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-md p-3">
          <div class="flex items-start">
            ...
            <div class="text-sm text-amber-700 dark:text-amber-300">
              <p class="font-medium mb-1">Producto Temporal</p>
              <p>Este producto <strong>NO se guardará</strong> en el catálogo. Solo aparecerá en esta orden de compra y no estará disponible para futuras órdenes.</p>
            </div>
          </div>
        </div>
