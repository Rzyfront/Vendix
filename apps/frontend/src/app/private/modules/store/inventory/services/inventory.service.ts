...
export class InventoryService {
    ...
    updateLocation(id: number, data: UpdateLocationDto): Observable<ApiResponse<InventoryLocation>> {
        return this.http
            .patch<ApiResponse<InventoryLocation>>(`${this.base_url}/locations/${id}`, data)
            .pipe(catchError(this.handleError));
    }
    ...
    getAdjustments(query: AdjustmentQueryDto = {}): Observable<ApiResponse<{ adjustments: InventoryAdjustment[]; total: number; has_more: boolean }>> {
        const params = this.buildParams(query);
        return this.http
            .get<ApiResponse<{ adjustments: InventoryAdjustment[]; total: number; has_more: boolean }>>(`${this.base_url}/adjustments`, { params })
            .pipe(catchError(this.handleError));
    }

    getAdjustmentById(id: number): Observable<ApiResponse<InventoryAdjustment>> {
        return this.http
            .get<ApiResponse<InventoryAdjustment>>(`${this.base_url}/adjustments/${id}`)
            .pipe(catchError(this.handleError));
    }

    createAdjustment(data: CreateAdjustmentDto): Observable<ApiResponse<InventoryAdjustment>> {
        return this.http
            .post<ApiResponse<InventoryAdjustment>>(`${this.base_url}/adjustments`, data)
            .pipe(catchError(this.handleError));
    }

    approveAdjustment(id: number, approved_by_user_id: number): Observable<ApiResponse<InventoryAdjustment>> {
        return this.http
            .patch<ApiResponse<InventoryAdjustment>>(`${this.base_url}/adjustments/${id}/approve`, { approved_by_user_id })
            .pipe(catchError(this.handleError));
    }
    ...
    getAdjustmentSummary(organization_id: number, start_date?: string, end_date?: string): Observable<ApiResponse<any>> {
        let params = new HttpParams().set('organization_id', organization_id.toString());
    ...
    getMovements(query: MovementQueryDto = {}): Observable<ApiResponse<InventoryMovement[]>> {
        const params = this.buildParams(query);
        return this.http
            .get<ApiResponse<InventoryMovement[]>>(`${this.base_url}/movements`, { params })
            .pipe(catchError(this.handleError));
    }
    ...
    createMovement(data: CreateMovementDto): Observable<ApiResponse<InventoryMovement>> {
        return this.http
    ...
    getStockLevels(location_id?: number): Observable<ApiResponse<StockLevel[]>> {
        ...
        return this.http
            .get<ApiResponse<StockLevel[]>>(`${this.base_url}/stock-levels`, { params })
            .pipe(catchError(this.handleError));
    }

    getStockByProduct(product_id: number, organization_id?: number): Observable<ApiResponse<StockLevel[]>> {
        let params = new HttpParams();
        if (organization_id) params = params.set('organization_id', organization_id.toString());

        return this.http
            .get<ApiResponse<StockLevel[]>>(`${this.base_url}/consolidated-stock/product/${product_id}`, { params })
            .pipe(catchError(this.handleError));
    }
