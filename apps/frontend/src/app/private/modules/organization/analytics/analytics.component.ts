...
@Component({
  ...
  template: `
    <div class="p-6">
      <h1 class="text-2xl font-bold mb-6">Análisis e inteligencia empresarial</h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <p class="text-gray-600">Previsión de ventas y análisis de tendencias</p>
        </a>
        ...
        >
          ...
          <p class="text-gray-600">Rendimiento del producto en todas las tiendas</p>
        </a>
      </div>
    </div>
  `,
