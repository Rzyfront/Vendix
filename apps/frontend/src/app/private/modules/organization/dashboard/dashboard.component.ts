    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow-sm p-6 border" style="border-color: var(--border);">
          ...
          <h3 class="text-sm font-medium" style="color: var(--secondary);">Total Stores</h3>
          <p class="text-3xl font-bold mt-2" style="color: var(--text);">8</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border" style="border-color: var(--border);">
          ...
          <h3 class="text-sm font-medium" style="color: var(--secondary);">Organization Users</h3>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border" style="border-color: var(--border);">
          ...
          <h3 class="text-sm font-medium" style="color: var(--secondary);">Monthly Orders</h3>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border" style="border-color: var(--border);">
          <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-sm font-medium" style="color: var(--secondary);">+15%</span>
          </div>
          <h3 class="text-sm font-medium" style="color: var(--secondary);">Revenue</h3>
          <p class="text-3xl font-bold mt-2" style="color: var(--text);">$45,231</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-sm border" style="border-color: var(--border);">
        <div class="px-6 py-4 border-b" style="border-color: var(--border);">
          <h2 class="text-lg font-semibold" style="color: var(--text);">Organization Activity</h2>
        </div>
        <div class="p-6">
          <div class="space-y-4">
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                <p class="text-sm font-medium" style="color: var(--text);">New store created</p>
                <p class="text-sm" style="color: var(--secondary);">Downtown location added to organization</p>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                <p class="text-sm font-medium" style="color: var(--text);">New manager added</p>
                <p class="text-sm" style="color: var(--secondary);">Sarah Johnson assigned as store manager</p>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                <p class="text-sm font-medium" style="color: var(--text);">Sales report generated</p>
                <p class="text-sm" style="color: var(--secondary);">Monthly sales report available for download</p>
