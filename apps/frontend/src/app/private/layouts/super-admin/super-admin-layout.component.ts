...
export class SuperAdminLayoutComponent {
  ...
  private readonly routeTitles: Record<string, string> = {
    ...
    '/super-admin/fiscal': 'Fiscal Vendix',
    '/super-admin/fiscal/dashboard': 'Centro Fiscal',
    '/super-admin/fiscal/identity': 'Identidad',
    '/super-admin/fiscal/obligations': 'Obligaciones',
    '/super-admin/fiscal/declarations': 'Declaraciones',
    '/super-admin/fiscal/close': 'Cierre',
    '/super-admin/fiscal/audit': 'Auditoría',
    '/super-admin/fiscal/rules': 'Reglas',
    '/super-admin/fiscal/accounting': 'Contabilidad',
    '/super-admin/fiscal/accounting/chart-of-accounts': 'Plan de Cuentas',
    '/super-admin/fiscal/accounting/journal-entries': 'Asientos Contables',
    '/super-admin/fiscal/accounting/account-mappings': 'Mapeos Contables',
    '/super-admin/fiscal/accounting/reports': 'Reportes Contables',
