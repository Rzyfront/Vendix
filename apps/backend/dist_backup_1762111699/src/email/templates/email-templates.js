...
class EmailTemplates {
    static getVerificationTemplate(data) {
    ...
    static getOnboardingTemplate(data) {
...
EmailTemplates.BASE_URL = process.env.FRONTEND_URL || 'http://localhost:4200';
EmailTemplates.COMPANY_NAME = 'Vendix';
EmailTemplates.SUPPORT_EMAIL = 'soporte@vendix.com';
