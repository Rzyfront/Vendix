...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    async validate(payload) {
        ...
        console.log('JWT Strategy - Using secret:', this.configService.get('JWT_SECRET'));
        try {
            ...
            if (!user) {
                throw new common_1.UnauthorizedException('Usuario no encontrado en base de datos');
            }
            ...
            return {
                ...
                permissions: user.user_roles.flatMap((ur) => ur.roles?.role_permissions?.map((rp) => ({
