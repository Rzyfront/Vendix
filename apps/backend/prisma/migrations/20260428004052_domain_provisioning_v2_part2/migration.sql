...
-- SPLIT-NOTE: parte 2/2 — depende de que part1 (20260428004051) haya committeado los nuevos
--             valores de domain_status_enum (failed_ownership, failed_certificate, failed_alias,
--             pending_ownership) antes de poder referenciarlos en el WHERE del partial index
--             y en los UPDATEs de backfill.
