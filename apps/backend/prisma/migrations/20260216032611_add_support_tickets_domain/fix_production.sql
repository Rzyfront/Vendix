-- Fix production: ejecutar manualmente las tablas que la migración marcó como aplicada pero nunca creó.
-- Los enums ya existen en producción. Los DROP INDEX se omiten (causaron el fallo original).
