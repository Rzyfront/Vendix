...
async function seedSystemPaymentMethods() {
  console.log('Seeding system payment methods...');
  ...
  console.log('System payment methods seeded successfully!');
}

async function main() {
  try {
    await seedSystemPaymentMethods();
  } catch (error) {
