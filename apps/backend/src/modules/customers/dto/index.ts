...
export class CreateCustomerDto {
  ...
  @ApiPropertyOptional({
    example: false,
    description: '¿Verificado? (opcional)',
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: false,
    description: '¿Acepta marketing? (opcional)',
  })
  @IsBoolean()
  @IsOptional()
...
export class CustomerQueryDto {
  ...
  @ApiPropertyOptional({
    example: 'juan',
    description: 'Búsqueda por nombre o email (opcional)',
  })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({
    example: false,
    description: '¿Incluir inactivos? (opcional)',
  })
  @IsOptional()
  @Transform(({ value }) => value === 'true')
  @IsBoolean()
