...
export class EmailService {
  ...
  private initializeConfig() {
    this.config = {
      provider: (this.configService.get<string>('EMAIL_PROVIDER') || 'console') as any,
      apiKey: this.configService.get<string>('EMAIL_API_KEY'),
      domain: this.configService.get<string>('EMAIL_DOMAIN'),
      fromEmail: this.configService.get<string>('EMAIL_FROM') || 'noreply@vendix.com',
  ...
  switchProvider(newProvider: 'resend' | 'sendgrid' | 'console', apiKey?: string) {
