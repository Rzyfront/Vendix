/**
 * Colombian Chart of Accounts (PUC) — Default Template
 *
 * Source data: Decreto 2650 de 1993 + Resolución 040 de 2023.
 *
 * Shared between:
 *  - `apps/backend/prisma/seeds/default-puc.seed.ts` (seed runner)
 *  - `apps/backend/src/common/services/default-chart-of-accounts-seeder.service.ts`
 *    (HTTP-triggered tenant seeder)
 *
 * Hierarchy:
...
export interface PucAccountInput {
  code: string;
  name: string;
...
export function getColombiaPucAccounts(): PucAccountInput[] {
  ...
  return [
    ...
    a('135520', 'Saldo a Favor en IVA', 'asset', 'debit', '1355'),
    ...
    a('240810', 'IVA por Pagar - Liquidación', 'liability', 'credit', '2408'),
