 ...
 * así que no pueden volver a declarar cosas distintas sobre el mismo NIT.
 *
 * Hasta el commit `92e5b91a7` (paso 4 del plan de SSOT) este archivo exponía un
 * kill switch `FISCAL_IDENTITY_LEGACY_MODE` con la cascada anterior. Fue
 * eliminado en el paso 7 del plan una vez verificado el rollout — el código
 * de la cascada legacy se conserva en `src/scripts/fiscal-ssot/dian-pre-deploy-gate.ts`
 * como referencia del pre-deploy gate.
 */
