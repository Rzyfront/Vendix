...
export const ALL_FORMAT_TYPES: print_format_type_enum[] = [
  ...
  // [print-editor-dsk P8] — Lote 12–15. La migración
  // 20260827_add_print_format_enum_values los agrega al enum de Postgres;
  // `prisma generate` los materializará en @prisma/client más adelante. El
  // cast `as unknown as print_format_type_enum` los mantiene en verde
  // hasta entonces.
...
> = {
  ...
  ...({
    ...
    // [print-editor-dsk P8] — Lote 12–15. Mismo motivo del cast que arriba.
