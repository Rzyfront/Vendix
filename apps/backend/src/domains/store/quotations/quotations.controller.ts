...
export class QuotationsController {
  ...
  async findAll(@Query() query: QuotationQueryDto) {
    ...
    return this.responseService.success(result, 'Cotizaciones obtenidas exitosamente');
  }
  ...
  async create(@Body() dto: CreateQuotationDto) {
    ...
    return this.responseService.created(result, 'Cotización creada exitosamente');
  }
  ...
  async getStats() {
    ...
    return this.responseService.success(result, 'Estadísticas de cotizaciones obtenidas');
  }
  ...
  async findOne(@Param('id', ParseIntPipe) id: number) {
    ...
    return this.responseService.success(result, 'Cotización obtenida exitosamente');
  }

  @Patch(':id')
  @Permissions('store:quotations:update')
  async update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateQuotationDto) {
    const result = await this.quotationsService.update(id, dto);
    return this.responseService.updated(result, 'Cotización actualizada exitosamente');
  }
  ...
  async send(@Param('id', ParseIntPipe) id: number) {
    ...
    return this.responseService.success(result, 'Cotización enviada exitosamente');
  }
  ...
  async accept(@Param('id', ParseIntPipe) id: number) {
    ...
    return this.responseService.success(result, 'Cotización aceptada exitosamente');
  }
  ...
  async reject(@Param('id', ParseIntPipe) id: number) {
    ...
    return this.responseService.success(result, 'Cotización rechazada exitosamente');
  }
  ...
  async cancel(@Param('id', ParseIntPipe) id: number) {
    ...
    return this.responseService.success(result, 'Cotización cancelada exitosamente');
  }
  ...
  async convert(@Param('id', ParseIntPipe) id: number) {
    ...
    return this.responseService.success(result, 'Cotización convertida a orden exitosamente');
  }
  ...
  async duplicate(@Param('id', ParseIntPipe) id: number) {
    ...
    return this.responseService.created(result, 'Cotización duplicada exitosamente');
  }
}
