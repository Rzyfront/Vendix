import { Controller, Get, Query, UseGuards, HttpStatus, Res, Header } from '@nestjs/common';
import {
    ApiTags,
    ApiOperation,
    ApiResponse,
...
export class AuditController {
    ...
    async getAuditLogs(
        ...
        return this.responseService.paginated(result.data, page, limitNum, result.total);
    }
