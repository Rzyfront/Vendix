...
// El import del módulo es PEREZOSO a propósito. `describe.skip` salta los tests
// pero NO evita que jest ejecute los imports de nivel superior: cargar el grafo
// de AuthModule en un worker construye el árbol completo de módulos y lo tumba
// por memoria (SIGTERM), dejando la suite unitaria en rojo por un spec que ni se
// iba a ejecutar. Resolviéndolo dentro del beforeAll, el costo solo se paga
// cuando la compuerta destructiva está abierta.
...
describeDestructiveE2E('Owner Registration Flow - Focused Integration Tests', () => {
