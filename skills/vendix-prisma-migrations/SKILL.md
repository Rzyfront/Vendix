...
description: >
  ...
  idempotent SQL, and deployment troubleshooting.
...
metadata:
  ...
  version: "1.0"
  scope: [root]
  auto_invoke: "Creating migrations, editing migration SQL, deploying migrations to production, recovering from P3009, failed migration recovery, ALTER TYPE ADD VALUE"
---
