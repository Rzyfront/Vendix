...
| Adding dependencies to apps/mobile/package.json | `mobil-dev` |
...
| Developing features for the mobile app | `mobil-dev` |
...
| Editing or creating any file under apps/mobile | `mobil-dev` |
